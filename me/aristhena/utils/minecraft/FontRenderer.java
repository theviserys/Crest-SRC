...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    private void readFontTexture() {
        ...
        try {
            bufferedimage = TextureUtil.readBufferedImage(ClientUtils.mc().getResourceManager().getResource(this.locationFontTexture).getInputStream());
        }
        ...
        for (int var3 = 0; var3 < p_78255_1_.length(); ++var3) {
            ...
            if (var4 == '§' && var3 + 1 < p_78255_1_.length()) {
                ...
                if (this.strikethroughStyle) {
                    ...
                    var11.addVertex(this.posX, this.posY + (float)(this.FONT_HEIGHT / 2), 0.0);
                    var11.addVertex(this.posX + var9, this.posY + (float)(this.FONT_HEIGHT / 2), 0.0);
                    var11.addVertex(this.posX + var9, this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0, 0.0);
                    var11.addVertex(this.posX, this.posY + (float)(this.FONT_HEIGHT / 2) - 1.0, 0.0);
                    var10.draw();
                ...
                if (this.underlineStyle) {
                    ...
                    var11.addVertex(this.posX + (float)var12, this.posY + (float)this.FONT_HEIGHT, 0.0);
                    var11.addVertex(this.posX + var9, this.posY + (float)this.FONT_HEIGHT, 0.0);
                    var11.addVertex(this.posX + var9, this.posY + (float)this.FONT_HEIGHT - 1.0, 0.0);
                    var11.addVertex(this.posX + (float)var12, this.posY + (float)this.FONT_HEIGHT - 1.0, 0.0);
                    var10.draw();
                    GlStateManager.enableTexture2D();
                }
                this.posX += var9;
