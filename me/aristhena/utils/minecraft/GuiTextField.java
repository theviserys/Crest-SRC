    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                var9 = this.fontRendererInstance.drawString(var4.substring(var2), (float)var9, (float)var8, var1);
            }
            if (var6) {
                if (var11) {
                    ...
                    this.fontRendererInstance.drawString("_", (float)var12, (float)var8, var1);
                }
            }
            if (var3 != var2) {
