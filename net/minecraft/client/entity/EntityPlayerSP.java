...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void func_175161_p()
    {
        ...
        if (this.func_175160_A())
        {
            ...
            double var5 = eventPre.getY() - this.field_175166_bJ;
            double var7 = this.posZ - this.field_175167_bK;
            double var9 = (double)(eventPre.getYaw() - this.field_175164_bL);
            double var11 = (double)(eventPre.getPitch() - this.field_175165_bM);
            boolean var13 = var3 * var3 + var5 * var5 + var7 * var7 > 9.0E-4D || this.field_175168_bP >= 20;
            boolean var14 = var9 != 0.0D || var11 != 0.0D;

            if (this.ridingEntity == null || eventPre.shouldAlwaysSend())
            {
                if (var13 && var14)
                {
            ...
            if (var14)
            {
                this.field_175164_bL = eventPre.getYaw();
                this.field_175165_bM = eventPre.getPitch();
            }
        }
