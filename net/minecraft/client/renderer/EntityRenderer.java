...
import me.aristhena.crest.module.modules.render.Brightness;
import me.aristhena.crest.module.modules.render.ViewClip;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void updateLightmap(float partialTicks)
    {
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (var2 != null)
            {
                if (Config.isCustomColors() && CustomColors.updateLightmap(var2, this.torchFlickerX, this.lightmapColors, this.mc.thePlayer.isPotionActive(Potion.nightVision) || new Brightness().getInstance().isEnabled()))
                {
