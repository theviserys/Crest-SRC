...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void func_180454_a(final ItemStack p_180454_1_, final IBakedModel p_180454_2_, final boolean effect) {
        if (effect) {
            this.func_180454_a(p_180454_1_, p_180454_2_);
        }
        else {
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5f, 0.5f, 0.5f);
    ...
    private void func_175032_a(final WorldRenderer p_175032_1_, final List p_175032_2_, final int p_175032_3_, final ItemStack p_175032_4_) {
        ...
        for (Object o : p_175032_2_) {
            BakedQuad var7 = (BakedQuad)o;
    ...
    public void renderItemIntoGUI(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_, boolean effect) {
        IBakedModel var4 = this.itemModelMesher.getItemModel(p_175042_1_);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        this.field_175057_n.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
        ...
        func_180452_a(p_175042_2_, p_175042_3_, var4.isAmbientOcclusionEnabled());
        func_175034_a((var4.getItemCameraTransforms()).field_178354_e);
        func_180454_a(p_175042_1_, var4, effect);
        GlStateManager.disableAlpha();
        GlStateManager.disableRescaleNormal();
        GlStateManager.disableLighting();
        GlStateManager.popMatrix();
