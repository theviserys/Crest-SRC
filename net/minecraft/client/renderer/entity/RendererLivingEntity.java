...
import me.aristhena.crest.module.modules.render.ESP;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void doRender(final EntityLivingBase p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        ...
        try {
            ...
            if (espInstance.isEnabled() && espInstance.isOutline() && !p_76986_1_.equals(Minecraft.getMinecraft().getRenderManager().livingPlayer)) {
                GL11.glPushMatrix();
                this.renderModel(p_76986_1_, var18, var17, var14, var12, var15, 0.0625f);
                espInstance.renderOne(p_76986_1_);
                this.renderModel(p_76986_1_, var18, var17, var14, var12, var15, 0.0625f);
                espInstance.renderTwo(p_76986_1_);
                this.renderModel(p_76986_1_, var18, var17, var14, var12, var15, 0.0625f);
                espInstance.renderThree(p_76986_1_);
                espInstance.renderFour(p_76986_1_);
                this.renderModel(p_76986_1_, var18, var17, var14, var12, var15, 0.0625f);
                espInstance.renderFive(p_76986_1_);
                GL11.glPopMatrix();
            }
