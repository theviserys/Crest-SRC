...
import me.aristhena.crest.module.modules.movement.Step;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z)) {
                StepEvent stepEvent = new StepEvent((double)this.stepHeight, Event.State.PRE);
                ...
                if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                    ...
                    if (stepEvent.isActive() && stepEvent.getStepHeight() > 0.0D && var54 && (var13 != var56 || var17 != var27)) {
                        ...
                        this.func_174826_a(this.getEntityBoundingBox().offset(0.0D, y + (((Step)(new Step()).getInstance()).packet ? 0.0D : 0.063D), 0.0D));
                        if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                            x = var56;
                            y = var25;
                            z = var27;
                            ...
                            (new StepEvent((double)this.stepHeight, Event.State.POST)).call();
                        }
                    }
                }
            }
            ...
            if (this.canTriggerWalking() && !var19 && this.ridingEntity == null) {
                ...
                this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var27 * var27 + var66 * var66) * 0.6D);
                this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(var27 * var27 + var64 * var64 + var66 * var66) * 0.6D);
            ...
            try {
                ...
                CrashReport var63 = CrashReport.makeCrashReport(var96, "Checking entity block collision");
